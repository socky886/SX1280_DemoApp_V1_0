...
/*!
 * \brief Represents the state of spy ranging
 */
typedef enum
{
    SPY_RANGING_ENABLE,
    SPY_RANGING_DISABLE,
}RadioSpyRangingStates_t;
...
typedef enum
{
    ...
    IRQ_RANGING_SPY_ERROR_CODE,
    IRQ_RANGING_SPY_VALID_CODE,
}IrqRangingCode_t;
